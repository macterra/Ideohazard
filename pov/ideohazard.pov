...
light_source
{
    225*x // light's position (translated below)
    color red 1.0  green 1.0  blue 1.0  // light's color
    looks_like { object { Sun scale 40 } }
}

/*
object { Wisp
    rotate (-600*clock + 45)*y
    rotate 30*z
}

object { Wisp
    rotate (-600*clock + 165)*y
    rotate 30*z
}

object { Wisp
    rotate (-600*clock + 285)*y
    rotate 30*z
}
*/
...
// plane { z, 200 pigment {White} finish {ambient 1} }
